...
if (isset($email) && isset($key))
{
    ...
    //veritabani activ kontrol kısmı eger linke tıklanmişsa bundan sonra birşey olmayacak basmamişsa kırmızı uyari verecek.
    $query_activate_account = "UPDATE members SET Activation=NULL WHERE(Email ='$email' AND Activation='$key')LIMIT 1";
    //linke tıkladiktan sonra veritabanindan burasi bir olarak degişir.
