 ...
 function talep()
{
 ...
 <div class="span9">
  ...
  <button type="button" class="btn btn-primary btn-lg btn-block"  data-toggle="modal" href="#chat_modalpuzzle" onclick="ap('http://localhost/ci/index.php/user/puzzleaap/{$foo}','chat_modalpuzzle');">AAP DONUSTUR</button> 

  <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" href="#chat_modaltalep" onclick="ap('http://localhost/ci/index.php/user/talephediye/{$foo}','chat_modaltalep');"> TAMAMLANANA PUZZLE TALEP ET</button>  
                    </div>
