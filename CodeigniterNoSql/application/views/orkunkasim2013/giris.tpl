   ...
   $(document).ready(function(){
                      ...
                      $("#sifre").change(function() { 
                        ...
                        var usr = $("#sifre").val();
                          ...
                          $("#statusb").html('sifre gir, sifre kisa');
                          }
...
<div id="content"><!-- buraya giris saydasinda ki video ve giris tusu bulunur-->
  ...
  <div id="static" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false" style="width:810px;" >
          <div class="modal-dialog modal-exwide" style="width:800px; height:500px;">
                                 ...
                                 <div class="modal-body ">
                                   ...
                                   <div class="tab-content">
                                          <div class="tab-pane active" id="tab1">
                                                 <form  action="{$BASEURL}user/register" method="post"  id="registerform">
                                                 <label> Kullanıcı Adı</label>
                                                 <input type="text" class="span2"  name="isim" id="isim"/><span id="status"></span><br/>
                                                 <label> Email</label>
                                                 <input type="email" class="span2"   name="email" id="email"/><span id="statusa"></span><br/>
                                                 <label> Şifre</label>
                                                 <input type="password" class="span2"  name="sifre" id="sifre"/></br><span id="statusb"></span><br/>
                                                 <button type="submit" class="btn btn-success" id="gonder">Kayıt</button>
                                                 <button type="reset" class="btn">Temizle</button>
                                               </form> 

                                          </div></br>
                                          <div class="tab-pane" id="tab2">
                                              <form  action="{$BASEURL}user/login" method="post" id="loginform">
                                                 <label> Kullanıcı Adı:</label>
                                                 <input type="text" class="span3" name="isim"  /><br/>
                                                 <label> Şifre</label>
                                                 <input type="password" class="span3" name="sifre" /><br/>
                                               <br/>
...
<!--  <div class="modal-header">
  ...
  <div id="stack2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
    ...
    <div class="modal-body">
                  ...
                  <button class="btn btn-success" data-dismiss="modal" id="InfroTextSubmit" onclick="sorgula()">ŞİFREMİ ŞİFİRLA </button>
